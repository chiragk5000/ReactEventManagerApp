import { Avatar, Grid2, Paper, Stack, Typography, Box, Chip, Divider, Button } from '@mui/material';
...
export default function ProfileHeader() {
    ...
    return (
        <Paper elevation={3} sx={{ pt: 4, borderRadius: 3 }}>
                    ...
                    <Stack spacing={2} alignItems={'center'}>
                        ...
                        {!isCurrentUser &&
                            <>
                                ...
                                disabled={updateFollowing.isLoading}
                                fullWidth 
                                variant={'outlined'} 
